...
namespace Banking_Project.DataAccessLayer.Migrations
{
    ...
    [Migration("20240429120300__add_new_properties_to_CustomerAccount_table")]
    partial class _add_new_properties_to_CustomerAccount_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Banking_Project.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Banking_Project.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Banking_Project.EntityLayer.Concrete.CustomerAccount", b =>
                {
            ...
            modelBuilder.Entity("Banking_Project.EntityLayer.Concrete.CustomerAccount", b =>
                {
                    b.HasOne("Banking_Project.EntityLayer.Concrete.AppUser", "AppUser")
            ...
            modelBuilder.Entity("Banking_Project.EntityLayer.Concrete.CustomerAccountProcess", b =>
                {
                    b.HasOne("Banking_Project.EntityLayer.Concrete.CustomerAccount", "ReceiverCustomer")
                        .WithMany("CustomerReceiver")
                        .HasForeignKey("ReceiverId");

                    b.HasOne("Banking_Project.EntityLayer.Concrete.CustomerAccount", "SenderCustomer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Banking_Project.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Banking_Project.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
